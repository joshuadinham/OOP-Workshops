...
//            for (i = 0; i < no_of_traces && check; ++i)
//            {
//                check = read(users[i].dayofweek) && read(users[i].user_id) &&
//                    read(users[i].timeinhours) && read(users[i].dayofyear) &&
//                    read(users[i].Fwifitime) && read(users[i].Fctime) && read(users[i].Package_Name);
//            }
//            
//            for (i = 0; i < no_of_traces; ++i)
//            {
//                //cout << users[i].dayofweek << " " << users[i].user_id << " "
//                    << users[i].timeinhours << " "
//                    << users[i].dayofyear << " "
//                    << users[i].Fwifitime << " "
//                    << users[i].Fctime << " "
...
>>>>>>> de8d4a5fd956d4ffbb367a6e57b15f7cb1fcb5e3
